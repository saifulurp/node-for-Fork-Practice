...
* \[[`5443033fe0`](https://github.com/nodejs/node/commit/5443033fe0)] - **build**: reclaim disk space on macOS GHA runner (jakecastelli) [#54658](https://github.com/nodejs/node/pull/54658)
...
* \[[`af82b0e5b6`](https://github.com/nodejs/node/commit/af82b0e5b6)] - **doc**: add support me link for anonrig (Yagiz Nizipli) [#54611](https://github.com/nodejs/node/pull/54611)
* \[[`9f817a5424`](https://github.com/nodejs/node/commit/9f817a5424)] - **doc**: add alert on REPL from TCP socket (Rafael Gonzaga) [#54594](https://github.com/nodejs/node/pull/54594)
* \[[`1b176f0b2a`](https://github.com/nodejs/node/commit/1b176f0b2a)] - **doc**: fix typo in styleText description (Rafael Gonzaga) [#54616](https://github.com/nodejs/node/pull/54616)
...
* \[[`a3e643b700`](https://github.com/nodejs/node/commit/a3e643b700)] - **src**: add helpers for creating cppgc-managed wrappers (Joyee Cheung) [#52295](https://github.com/nodejs/node/pull/52295)
* \[[`7d83f374c2`](https://github.com/nodejs/node/commit/7d83f374c2)] - **src**: support v8::Data in heap utils (Joyee Cheung) [#52295](https://github.com/nodejs/node/pull/52295)
...
* \[[`7d477742a8`](https://github.com/nodejs/node/commit/7d477742a8)] - **test**: fix test-tls-client-auth test for OpenSSL32 (Michael Dawson) [#54610](https://github.com/nodejs/node/pull/54610)
* \[[`f9c856160a`](https://github.com/nodejs/node/commit/f9c856160a)] - **test**: update TLS test for OpenSSL 3.2 (Richard Lau) [#54612](https://github.com/nodejs/node/pull/54612)
* \[[`f85b88c85a`](https://github.com/nodejs/node/commit/f85b88c85a)] - **test**: run V8 Fast API tests in release mode too (Michaël Zasso) [#54570](https://github.com/nodejs/node/pull/54570)
* \[[`f1a16afd9a`](https://github.com/nodejs/node/commit/f1a16afd9a)] - **test**: increase key size for ca2-cert.pem (Michael Dawson) [#54599](https://github.com/nodejs/node/pull/54599)
* \[[`465838eecb`](https://github.com/nodejs/node/commit/465838eecb)] - **test**: update test-abortsignal-cloneable to use node:test (James M Snell) [#54581](https://github.com/nodejs/node/pull/54581)
* \[[`4aca21f02a`](https://github.com/nodejs/node/commit/4aca21f02a)] - **test**: update multiple assert tests to use node:test (James M Snell) [#54585](https://github.com/nodejs/node/pull/54585)
...
* \[[`a9b607a7a1`](https://github.com/nodejs/node/commit/a9b607a7a1)] - **vm**: migrate ContextifyScript to cppgc (Joyee Cheung) [#52295](https://github.com/nodejs/node/pull/52295)
* \[[`f67cdf8cc8`](https://github.com/nodejs/node/commit/f67cdf8cc8)] - **vm**: return all own names and symbols in property enumerator interceptor (Chengzhong Wu) [#54522](https://github.com/nodejs/node/pull/54522)
